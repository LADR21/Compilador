...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOK_LPAREN = 6,                 /* "("  */
  YYSYMBOL_TOK_RPAREN = 7,                 /* ")"  */
  YYSYMBOL_YYACCEPT = 8,                   /* $accept  */
  YYSYMBOL_sexps = 9,                      /* sexps  */
  YYSYMBOL_sexp = 10,                      /* sexp  */
  YYSYMBOL_list = 11,                      /* list  */
  YYSYMBOL_atom = 12                       /* atom  */
};
...
static const char *const yytname[] =
{
  ...
  "\"string\"", "\"identifier\"", "\"(\"", "\")\"", "$accept", "sexps",
  "sexp", "list", "atom", YY_NULLPTR
};
...
#line 1353 "parser.tab.c"
  ...
  case 3: /* sexp: atom  */
#line 44 "parser.y"
                { (yyval.sexp) = new_sexp_node(ST_ATOM, (yyvsp[0].atom)); }
...
#line 1377 "parser.tab.c"
  ...
  case 7: /* atom: "number"  */
#line 52 "parser.y"
                { (yyval.atom) = new_atom_node(AT_NUMBER, (void *)(&(yyvsp[0].NUMBER))); }
#line 1383 "parser.tab.c"
    break;

  case 8: /* atom: "identifier"  */
#line 53 "parser.y"
                { (yyval.atom) = new_atom_node(AT_IDENTIFIER, (void *)(yyvsp[0].IDENTIFIER)); }
#line 1389 "parser.tab.c"
    break;

  case 9: /* atom: "string"  */
#line 54 "parser.y"
                { (yyval.atom) = new_atom_node(AT_STRING, (void *)(yyvsp[0].STRING)); }
